...
Setup Environment - Shell/Terminal
Jika Anda lebih suka menggunakan Shell atau Terminal, ikuti langkah-langkah berikut:
...
pip install -r requirements.txt
Menjalankan Aplikasi Streamlit
Setelah semua dependensi terinstal dan lingkungan siap, Anda dapat menjalankan aplikasi Streamlit dengan perintah berikut:
